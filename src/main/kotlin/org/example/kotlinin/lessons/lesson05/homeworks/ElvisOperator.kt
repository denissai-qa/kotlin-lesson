package org.example.org.example.kotlinin.lessons.lesson05.homeworks
...
// которая составляет 0,5% от его стоимости. В случае, если стоимость не указана, то берётся стандартная
// стоимость в $50
...
fun main () { //задача 1
    ...
    val coefficient: Double? = 0.59 // но может быть null
